# AdiBags - Battle for Azeroth

**Adds multiple (optionally colored) categories for the most common Battle for Azeroth items in AdiBags (AdiBags is required!).**
...
If anything is missing, misplaced, or you want a new category, then please write a comment or [open an issue](https://github.com/Zottelchens-WoW-Addons/AdiBags-BattleForAzeroth/issues). There are literally thousands of item IDs in this addon, so I may have missed or misplaced something. Report these items & I will fix them ASAP. Thanks! :)
...
**If you want to contribute too, you can do so by submitting translations [directly on Curseforge](https://legacy.curseforge.com/wow/addons/adibags-battle-for-azeroth/localization).**
